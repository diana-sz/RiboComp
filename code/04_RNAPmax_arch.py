...
* archaeal transcription & translation rate and ribosome mass
"""
...
# archaea parameters
c = 25*3600
kel = 25/3*3600 #25/(85/22.25)*3600
Mtot = 3040

prot_fractions = np.arange(0.01, 1, 0.01)  # protein fractions to test
mus = np.arange(0.5,1.5,0.001) # growth rates to test

last_mus = []
prog = 0
plt.title("RBA+RNAP_max Archaea")
...
res.to_csv("../data/04_RNAPmax_arch.csv")
